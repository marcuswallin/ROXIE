...
def main():
    file1 = '\\\\cern.ch\\dfs\\Users\\m\\mwallin\\' \
        + 'Documents\\ROXIE\\Processed Data\\MBHSP\\Angular.csv'
    ...
    magnet2 = Magnet(m_properties2, [[mag_mid, 0.00]], 1000, 12000)
    ...
    print('Integrated voltage from movement: ', gain*(phi_move1+phi_move2-2*phi0))
    print('Integrated voltage from current drop: ', gain*(deltaI*0.001*QA_length*0.011*36))
